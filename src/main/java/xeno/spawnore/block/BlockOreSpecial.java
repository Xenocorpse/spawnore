...
public class BlockOreSpecial extends BlockBase {
	
	private final boolean isOn;

	public BlockOreSpecial(Material mat, String name, String tool, int harvest, boolean isOn, SoundType sound) {
		super(mat, name, tool, harvest, sound);
